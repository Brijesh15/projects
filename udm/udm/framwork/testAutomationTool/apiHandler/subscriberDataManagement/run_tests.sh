...
DEFAULT_UDM_SIM="$SCRIPTPATH"/../../../../start_dummy_udramData.sh
...
do
		...
		then
			...
			if [[ "$get_request_json_file" != "" ]]
			then
				curl -s --show-error -D get_resp_headers.txt -H "Content-Type: application/json" -H 'Accept: application/json; indent=4' "http://127.0.0.1:9000/nudm-sdm/v2/imsi-311480012345674/am-data/?plmnId=311480" --request GET -o get_resp.json
